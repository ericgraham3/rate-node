...
# Contract: BaseStateCalculator
#
# This file defines the interface contract that all state calculators must implement.
# It is a DESIGN ARTIFACT - the actual implementation will be placed in:
#   lib/ratenode/calculators/base_state_calculator.rb
#

...
RSpec.describe TitleRound::Calculators::BaseRate do
  ...
  describe "#calculate" do
    it "uses rounded liability for rate lookup" do
      rate_on_boundary = described_class.new(50_000_000).calculate
      rate_just_over = described_class.new(50_000_100).calculate
